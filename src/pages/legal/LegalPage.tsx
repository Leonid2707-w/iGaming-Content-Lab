...
export function PersonalDataPage() {
  return (
    <LegalPage title="Политика обработки персональных данных">
      ...
      <p>
        Сайт может использовать Cookie-файлы и сходные технологии для обеспечения работоспособности
        сервиса, сохранения пользовательских настроек (например, темы оформления и сессии) и
        улучшения качества сервиса. Cookie могут содержать технические идентификаторы, связанные с
        работой браузера. Пользователь может ограничить Cookie в настройках браузера; при этом
